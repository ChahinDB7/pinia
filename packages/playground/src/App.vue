...
const sourceCodeLink = computed(() => {
  if (route.name) {
    return `https://github.com/ChahinDB7/pinia/blob/v2/packages/playground/src/views/${String(
      route.name
    )}.vue`
  } else {
    return `https://github.com/ChahinDB7/pinia/blob/v2/packages/playground/src/`
  }
})
</script>
