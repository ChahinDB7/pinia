...
export const enConfig: LocaleSpecificConfig<DefaultTheme.Config> = {
  ...
  themeConfig: {
    editLink: {
      pattern: 'https://github.com/ChahinDB7/pinia/edit/v2/packages/docs/:path',
    ...
    nav: [
      ...
      { text: 'Cookbook', link: '/cookbook/', activeMatch: '^/cookbook/' },
      {
        ...
        items: [
          {
            text: 'Discussions',
            link: 'https://github.com/ChahinDB7/pinia/discussions',
          },
          {
            text: 'Changelog',
            link: 'https://github.com/ChahinDB7/pinia/blob/v2/packages/pinia/CHANGELOG.md',
          },
          {
