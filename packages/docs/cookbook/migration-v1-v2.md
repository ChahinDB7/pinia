...
Starting at version `2.0.0-rc.4`, pinia supports both Vue 2 and Vue 3! This means, all new updates will be applied to this version 2 so both Vue 2 and Vue 3 users can benefit from it. If you are using Vue 3, this doesn't change anything for you as you were already using the rc and you can check [the CHANGELOG](https://github.com/ChahinDB7/pinia/blob/v2/packages/pinia/CHANGELOG.md) for a detailed explanation of everything that changed. Otherwise, **this guide is for you**!
...
Added in [2.0.0-rc.0](https://github.com/ChahinDB7/pinia/blob/v2/packages/pinia/CHANGELOG.md#200-rc0-2021-07-28)
